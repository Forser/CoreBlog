using Moq;
using Xunit;
using CoreBlog.Infrastructures;
...
namespace CoreBlog.Tests
{
    public class PageLinkTagHelperTests
    {
        ...
        public void Can_Generate_Page_Links()
        {
            ...
            TagHelperOutput output = new TagHelperOutput("li", new TagHelperAttributeList(), (cache, encoder) => Task.FromResult(content.Object));

            // Act
            helper.Process(ctx, output);

            // Assert
            Assert.Equal(@"<a href=""Test/Page1"">1</a></li>"
                + @"<li><a href=""Test/Page2"">2</a></li>"
                + @"<li><a href=""Test/Page3"">3</a></li>",
